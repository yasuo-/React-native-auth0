    ...
    actions: [
      {
        type: 'add',
        path:
          'src/screens/host/{{properCase name}}/{{properCase name}}Screen.js',
        templateFile: 'generators/screen/Screen.js.hbs',
      },
      {
        type: 'add',
        path:
          'src/screens/host/{{properCase name}}/{{properCase name}}Container.js',
        templateFile: 'generators/screen/ScreenContainer.js.hbs',
      },
    ],
  });

  plop.setGenerator('screen-gest', {
    description: 'Generates new Screen',
    prompts: [
      {
        type: 'input',
    ...
    actions: [
      {
        type: 'add',
        path:
          'src/screens/gest/{{properCase name}}/{{properCase name}}Screen.js',
        templateFile: 'generators/screen/Screen.js.hbs',
      },
      {
        type: 'add',
        path:
          'src/screens/gest/{{properCase name}}/{{properCase name}}Container.js',
        templateFile: 'generators/screen/ScreenContainer.js.hbs',
      },
    ],
  });
